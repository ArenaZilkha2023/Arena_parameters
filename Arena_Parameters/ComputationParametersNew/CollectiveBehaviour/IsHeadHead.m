function [Index_Beg Index_End]=IsHeadHead(I1,HeadHeadDistance,TailTailDistance,DistanceToBeTogether)

       I2=(HeadHeadDistance < TailTailDistance) & (HeadHeadDistance < DistanceToBeTogether);
       I3=I1 & I2;
