function [chasing_all,chased_all]=ChasingCalSilviaVersion(Locomotion,Dist_tresh1,Velocity_Tresh,PathTresh,Dist_tresh2,angle_threshold)
            ...
            % Find both in the arena without hiding box
             ...
             Trajectory2(~isInArena(:,mouse2)|(TrajectoryX(:,mouse2)==1e6))=0; % if it is outside the arena and the trayectory is non-defined
                 if sum(sum(Trajectory2))==0 %in the case is not in the arena
                     ...
                     [chasing12 chasing21 IndexChasing allevents]=detectChasingSilviaVersion(Trajectory1,Trajectory2,Velocity1,Velocity2,...
