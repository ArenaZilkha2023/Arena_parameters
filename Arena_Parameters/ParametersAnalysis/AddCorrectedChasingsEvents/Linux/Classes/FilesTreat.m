classdef FilesTreat
    ...
    methods
        ...
        function FileName=FileName(obj,ListFiles,NFile)
                 
                FileName=ListFiles(NFile).name;
        end        
        ...
        function ReadFilesAllCSV=ReadFilesAllCSV(obj) %n is number of file
