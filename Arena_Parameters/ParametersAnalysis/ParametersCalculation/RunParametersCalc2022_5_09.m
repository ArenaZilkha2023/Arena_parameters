...
%% -------------- Add chasing corrected manually ---
  if get( h.ChangeManual,'Value')==1 % in the case of manually correction
              file_chasing_manual = strcat(get(h.editRunParams,'string'),'\',item_selected(t),'\',item_selected(t),'\','Results\','Chasing-manual.xlsx');
...
%                % hiding and sleeping for each hour
           ...
           % using excel file 
           % %%%%%%%%%%%%%%%%Load excel data %%%%%%%%%%%%%%%%%%%%
 if get( h.ChangeManual,'Value')==1
     ChasingFile=strcat(get(h.editRunParams,'string'),'\',item_selected(t),'\',item_selected(t),'\','Results\','Chasing-manual.xlsx');
 else    
