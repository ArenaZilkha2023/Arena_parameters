...
close(hbar);
    ...
    function ChasingCalvs2=ChasingCalvs2( obj,TrajectoryX,TrajectoryY,DeltaX,DeltaY,isInArena,RepeatedFrames,Velocity )
...
%                xlswrite('test.xlsx',Array)
            ...
            ChasingVector=FindEnds(BegChasingCorrected2, EndChasingCorrected2,ChasingVector,Trajectory1,Trajectory2,obj.GapPathEnd)
             ...
             chasing12=[BegChasingCorrected EndChasingCorrected mouse2*ones(length(BegChasingCorrected),1)  RepeatedFrames(BegChasingCorrected) RepeatedFrames(EndChasingCorrected)];%Return real frames
...
%% 
function ChasingVector=RealEvents(BegChasing, EndChasing,ChasingVector,Dx1,Dy1,Dx2,Dy2,MinimumPath,V1,V2)
