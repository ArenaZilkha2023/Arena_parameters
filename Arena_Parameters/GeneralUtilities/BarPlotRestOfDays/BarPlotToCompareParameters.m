...
[AverageWt,ErrorSTWt,DataExtractionWt]=MeanStWt(WtData,Firstday,Finalday,Parameters,RowEachParameter,MouseNumber,NumWtexp);
...
xlswrite(fullfile(PathName,'NuritExpSecondPhase.xlsx'),Newraw,'Nurit exp');
%% Plot
figure
