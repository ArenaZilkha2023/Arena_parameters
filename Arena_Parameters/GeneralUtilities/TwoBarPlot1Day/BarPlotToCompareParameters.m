%% Plot Plot a bar plot to compare only 2 experiments
clear all;
day=1;
MouseNumber=5;
...
Newraw(1,2)={'mean wt'};
Newraw(1,3)={'SE wt'};
Newraw(1,4)={'mean NK'}; %NK are mice which received a medication
Newraw(1,5)={'SE NK'};
...
xlswrite(fullfile(PathName,'AmitExpFirstDay.xlsx'),Newraw,'Amit exp');
%% Plot
figure
...
%    e=[ErrorSTExp(countP,1),ErrorSTExp(countP,2)];
 ...
 text(10,-100,'First day','FontSize',14,'Color','red')