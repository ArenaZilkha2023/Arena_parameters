function   [Average,ErrorST,DataExtraction]=MeanStdEForParameter(data,Firstday,Finalday,parameters,RowEachParameter,MouseNumber,Ielorating)
...
% if parameter==Ielorating %only for elorating
%    Aux=cell2mat(Aux)-1000; 
%    Aux=num2cell(Aux);
% end
