function Aux = ArrangeManualChased(Locomotion,fileName,file_chasing_manual)
...
for row = 1: size(selected_data,1) %go through each row
 ...
 switch mouse_chased  
    case 1
     Aux{1,mouse_chased}(count1,1:3) = [frame_begin,frame_end,mouse_chasing];  
     count1 = count1 +1;
    case 2
     Aux{1,mouse_chased}(count2,1:3) = [frame_begin,frame_end,mouse_chasing];  
     count2 = count2 +1;   
    case 3
    Aux{1,mouse_chased}(count3,1:3) = [frame_begin,frame_end,mouse_chasing];  
     count3 = count3 +1;
     case 4
      Aux{1,mouse_chased}(count4,1:3) = [frame_begin,frame_end,mouse_chasing];  
     count4 = count4 +1;   
    case 5
      Aux{1,mouse_chased}(count5,1:3) = [frame_begin,frame_end,mouse_chasing];  
     count5 = count5 +1;   
    otherwise
    end 
