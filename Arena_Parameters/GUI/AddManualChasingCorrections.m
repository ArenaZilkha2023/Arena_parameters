function [ output_args ] = AddManualChasingCorrections(~,~)
...
%  uicontrol(h.Layout,'Style', 'pushbutton', 'String','1- Set the path of your excel file with chasing events','position',[10,260,300,30],'callback',@LoadTxtData,'FontSize',9,'ForegroundColor','blue')
 ...
 uicontrol(h.Layout,'Style', 'text', 'String','Note: Prepare excel file called Chasing-manual.xlsx','position',[530,360,200,30],'FontSize',10,'ForegroundColor','red')
...
% uicontrol(h.Layout,'Style', 'pushbutton','String', '6- Apply randomization tests to your Elo rating results','position',[300,50,300,40],'FontSize',9,'ForegroundColor','blue','callback',@RunShuffling)
 ...
 uicontrol(h.Layout,'Style', 'pushbutton','String', '','position',[570,40,40,60],'FontSize',9,'ForegroundColor','blue','callback',@ManagerAddCorrections,'cdata',Image3)
 uicontrol(h.Layout,'Style', 'text', 'String','Add corrections to chasing mat files and create new excel with chasing events','position',[500,4,200,40],'FontSize',9,'ForegroundColor','blue')
% 
% %Create checkbox
